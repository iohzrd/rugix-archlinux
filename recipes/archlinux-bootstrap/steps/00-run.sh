...
# The script below is from https://github.com/tokland/arch-bootstrap
...
EXTRA_PACKAGES=(base-devel bash coreutils tar systemd)
EXTRA_PACKAGES=(${EXTRA_PACKAGES[*]} ${RECIPE_PARAM_EXTRA_PACKAGES[*]})
...
configure_minimal_system() {
  ...
  mkdir -p "$DEST/dev"
  # This presumably assigns password "root" to the root user,
...
main -a $ARCHLINUX_ARCH $RUGIX_ROOT_DIR